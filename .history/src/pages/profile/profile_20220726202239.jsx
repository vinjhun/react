...
const Profile = () => {
  ...
  if (user) return (<><div>Here suppose has user setting</div></>);

  return (
    <div className='flex flex-wrap min-h-[100vh]'>
      <div className='flex flex-col grow'>
        <div className='px-20 py-6 text-2xl italic semi-bold'>
          <h1>Its all where started... (In Construction)</h1>
        </div>
        <div
          className='mx-16 my-6 px-20 py-20 rounded-lg shadow-md shadow-[#A1887F] 
